...
typedef enum _Cluster__Cluster__LbPolicy {
  ...
  /*
   * NEW: Weighted round robin
   */
  CLUSTER__CLUSTER__LB_POLICY__WEIGHTED_ROUND_ROBIN = 6,
  /*
   * NEW: Sticky session affinity
   */
  CLUSTER__CLUSTER__LB_POLICY__STICKY_ROUND_ROBIN = 7
